...
from GameWorld.distributed import dist_init, print0
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='GameWorld', formatter_class=argparse.RawTextHelpFormatter)
    parser.add_argument(
        "--output_path",
        type=str,
    ...
    parser.add_argument(
        "--full_json_dir",
        type=str,
        default=f'{CUR_DIR}/GameWorld/GameWorld_full_info.json',
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        help="""This is for mode=='GameWorld_category'
...
def main():
    ...
    my_GameWorld = GameWorld(device, args.full_json_dir, args.output_path)
