...
def _parse_args():
    ...
    parser.add_argument('--vae_type', type=str, default='mg_lightvae_v2', choices=['wan', 'mg_lightvae', 'mg_lightvae_v2', 'taesd'], help='VAE type.')
    parser.add_argument('--taesd_path', type=str, default=None, help='Path to taew2_2.pth/.safetensors for --vae_type taesd. Defaults to <ckpt_dir>/taew2_2.pth.')
